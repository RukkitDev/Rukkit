...
public class TriangleDemo {
    ...
    private static long createPipeline(VkDevice device, long renderPass, VkPipelineVertexInputStateCreateInfo vi) throws IOException {
        ...
        shaderStages.get(0).set(loadShader(device, "./data/vulkan/triangle.vert", VK_SHADER_STAGE_VERTEX_BIT));
        shaderStages.get(1).set(loadShader(device, "./data/vulkan/triangle.frag", VK_SHADER_STAGE_FRAGMENT_BIT));
